...
<div class="wrapper">
    ...
    <section id="content">
        ...
        <center>
            <table border="2">
                <tbody>
                <tr><th>id Benevole</th><th>Prénom</th><th>Nom</th><th>Téléphone</th><th>Ville</th><th>Mission</th><th>Compétences</th><th>convention</th><th>charte</th><th>langues</th><th>festival</th><th>chantier</th><th>idCompte</th><th>Modifier</th><th>Supprimer</th></tr>
                </tbody>
                <?php
                /**
                 * Created by PhpStorm.
                 ...
                 */
                 ...
                 if (count($vListeBenevoles) >= 1) {
                    foreach ($vListeBenevoles as $bene) {
                        ...
                        echo '<td>'.$bene->prenom.'</td><td>'.$bene->nom.'</td><td>'.$bene->telephone.'</td><td>'.$bene->ville.'</td><td>'.$bene->mission.'</td><td>'.$bene->competences.'</td><td>'.$bene->conventionSignee.'</td><td>'.$bene->charteSignee.'</td><td>'.$bene->langues.'</td><td>'.$bene->festival.'</td><td>'.$bene->chantier.'</td><td align="center"><a href="index.php?entite=compte&action=R&id='.$bene->idCompte.'">'.$bene->idCompte.'</a>
