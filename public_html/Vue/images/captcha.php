...
//le fichier se nomme: captcha.php
//on indique au header qu'il faut afficher le code en tant qu'image
header('Content-Type: image/png');
$largeur=160;//largeur de l'image
$hauteur=50;//hauteur de l'image
$lignes=15;//nombre de lignes multicolore qui seront affichées avec le code (10 est bien)
...
imagestring($image, 5, 30, 18, $code, imagecolorallocate($image, 0, 0, 0));
//on affiche l'image
imagepng($image);
